...
namespace PlayFab
{
    ...
    internal class PlayFabSettingsRedirect : PlayFabApiSettings
    {
        ...
        public override string ProductionEnvironmentUrl
        {
            get
            {
                var so = GetSO(); return so == null ? base.ProductionEnvironmentUrl : so.ProductionEnvironmentUrl;
            }
            set
            {
                var so = GetSO(); if (so != null) so.ProductionEnvironmentUrl = value; base.ProductionEnvironmentUrl = value;
            }
        }
        ...
        internal override string VerticalName
        {
            get
            {
                var so = GetSO(); return so == null ? base.VerticalName : so.VerticalName;
            }
            set
            {
                var so = GetSO(); if (so != null) so.VerticalName = value; base.VerticalName = value;
            }
        }
        ...
        public override string DeveloperSecretKey
        {
            get
            {
                var so = GetSO(); return so == null ? base.DeveloperSecretKey : so.DeveloperSecretKey;
            }
            set
            {
                var so = GetSO(); if (so != null) so.DeveloperSecretKey = value; base.DeveloperSecretKey = value;
            }
        }
#endif
        ...
        public override string TitleId
        {
            get
            {
                var so = GetSO(); return so == null ? base.TitleId : so.TitleId;
            }
            set
            {
                var so = GetSO(); if (so != null) so.TitleId = value; base.TitleId = value;
            }
        }
        ...
        public override bool DisableDeviceInfo
        {
            get
            {
                var so = GetSO(); return so == null ? base.DisableDeviceInfo : so.DisableDeviceInfo;
            }
            set
            {
                var so = GetSO(); if (so != null) so.DisableDeviceInfo = value; base.DisableDeviceInfo = value;
            }
        }
        ...
        public override bool DisableFocusTimeCollection
        {
            get
            {
                var so = GetSO(); return so == null ? base.DisableFocusTimeCollection : so.DisableFocusTimeCollection;
            }
            set
            {
                var so = GetSO(); if (so != null) so.DisableFocusTimeCollection = value; base.DisableFocusTimeCollection = value;
            }
        }
        ...
        public override bool CompressResponses
        {
            get
            {
                var so = GetSO(); return so == null ? base.CompressResponses : so.CompressResponses;
            }
            set
            {
                var so = GetSO(); if (so != null) so.CompressResponses = value; base.CompressResponses = value;
            }
        }
        ...
        internal override bool DecompressWithDownloadHandler
        {
            get
            {
                var so = GetSO(); return so == null ? base.DecompressWithDownloadHandler : so.DecompressWithDownloadHandler;
            }
            set
            {
                var so = GetSO(); if (so != null) so.DecompressWithDownloadHandler = value; base.DecompressWithDownloadHandler = value;
            }
        }
    }
}
